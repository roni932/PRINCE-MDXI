...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~qunRZ0dBJqiBwCY65Qaq", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "918779798493", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Crush Lija Bot", // Input Yours custom...(Maintain font for Flow)
...
BAD_WORDS: process.env.BAD_WORDS || "fuck, pussy, anus, idiot,gud", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_📞 📵 No Calls Allowed!_*",
AUTO_REACT: process.env.AUTO_REACT || "true",
BOT_NAME: process.env.BOT_NAME || "Crush Lija Bot", //  don't change 
